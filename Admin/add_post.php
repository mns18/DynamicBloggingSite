            ...
            <main id='main_panel' class="text-white">
                <div class="container-fluid m-5 ">
                    ...
                    if(isset($_POST['add_post'])){
                        ...
                        $add_post_query = "INSERT INTO posts ( post_category_id, post_title, post_author, post_author_id, post_content, post_image, post_like, post_comment, post_status)";
                        $add_post_query .="  VALUES ($post_category, '$post_title', 'Admin', '0', '$post_content', '$post_image', 0, 0, '$post_status')";
