        ...
        <div class='col-9 border-left h-100 overflow-y-scroll overflow-x-hidden'>
            <main id='main_panel' class="text-white" style="height: 100vh;">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                    <?php 
                        $all_page_query = "SELECT * FROM posts WHERE post_status != 'trash'";
                        ...
                        if(mysqli_num_rows($all_category_res) > 0){
                            ...
                            while($post = mysqli_fetch_assoc($all_category_res)){
                                ...
                                <td><a href="edit_page.php?page_id=<?php echo $post_id;?>" class="text-decoration-none text-warning">Edit</a></td>
                                <td><a href="pages.php?delete_id=<?php echo $post_id;?>" class="text-decoration-none text-danger">Delete</a></td>
                            </tr>
                                <?php
                            }
                        }
