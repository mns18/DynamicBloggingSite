                ...
                <table class="table table-striped table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-white" scope="col">Remove</th>
                    ...
                    <?php 
                        ...
                        if(mysqli_num_rows($all_category_res) > 0){
                            ...
                            while($page = mysqli_fetch_assoc($all_category_res)){
                                ...
                                <td><a href="pages.php?delete_id=<?php echo $page_id;?>" class="text-decoration-none text-danger" href="trash_page.php?delete_id=<?php echo $$page_id; ?>">Remove</a></td>
                            </tr>
                                <?php
                            }
                        }
                    ...
                    if(isset($_GET['delete_id'])){
                        ...
                        $delete_query = "DELETE FROM pages WHERE page_id = $page_id ";
